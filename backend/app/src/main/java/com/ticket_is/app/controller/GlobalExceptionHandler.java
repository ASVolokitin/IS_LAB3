...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException exception) {
        ErrorResponse errorResponse = new ErrorResponse(exception.getMessage(), "Resource not found");
    ...
    //     return new ResponseEntity<>("Sorry, something gone wrong on the server side, maybe try again? :( ", HttpStatus.INTERNAL_SERVER_ERROR);
    // }
